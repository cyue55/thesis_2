...
from mbchl.training.losses import (ControllableNoiseReductionHearingLossCompensationLoss, 
                                   ControllableNoiseReductionHearingLossCompensationLosseFixedWeights, 
                                   ...
                                   ControllableNoiseReductionHearingLossCompensationLosseSpeechUncertainties, 
                                   LossPhilippeStyleTG2,
                                   ControllableNoiseReductionHearingLossCompensationLosseSixUncertainties,
                                   CNRHLCLossC8,
                                   CNRHLCLossC9,
                                   CNRHLCLossC10)
...
if __name__ == "__main__":
    ...
    def process_file(f):
        ...
        for profile, thresholds in standard_audiograms.items():
            ...
            # print(args.noisy, isinstance(
            #     model._loss, ControllableNoiseReductionHearingLossCompensationLoss
            # ))
            expected_multi_output_loss_types = (
                ControllableNoiseReductionHearingLossCompensationLoss,
                ControllableNoiseReductionHearingLossCompensationLosseFixedWeights,
                ControllableNoiseReductionHearingLossCompensationLosseAllUncertainties,
                ControllableNoiseReductionHearingLossCompensationLosseEnvUncertainties,
                ControllableNoiseReductionHearingLossCompensationLosseSpeechUncertainties,
            ...
            if not args.noisy and isinstance(
                model._loss, expected_multi_output_loss_types
            ):
